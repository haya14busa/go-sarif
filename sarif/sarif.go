...
type Address struct {
	...
	AbsoluteAddress                                                                           *int64       `json:"absoluteAddress,omitempty"`
	...
	// object.                                                                                             
	OffsetFromParent                                                                          *int64       `json:"offsetFromParent,omitempty"`
	...
	// object.                                                                                             
	RelativeAddress                                                                           *int64       `json:"relativeAddress,omitempty"`
}
...
type Invocation struct {
	...
	ExitSignalNumber                                                                            *int64                  `json:"exitSignalNumber,omitempty"`
...
type Region struct {
	...
	CharLength                                                                                  *int64           `json:"charLength,omitempty"`
...
type GraphTraversal struct {
	...
	ResultGraphIndex                                                                            *int64                              `json:"resultGraphIndex,omitempty"`
	// The index within the run.graphs to be associated with the result.                                                            
	RunGraphIndex                                                                               *int64                              `json:"runGraphIndex,omitempty"`
}
...
type EdgeTraversal struct {
	...
	StepOverEdgeCount                                                               *int64                              `json:"stepOverEdgeCount,omitempty"`
}
...
type ResultProvenance struct {
	...
	InvocationIndex                                                                             *int64             `json:"invocationIndex,omitempty"`
	// A GUID-valued string equal to the automationDetails.guid property of the run in which the                   
...
type Run struct {
	...
	ColumnKind                                                                                   *ColumnKind                     `json:"columnKind,omitempty"`
	// A conversion object that describes how a converter transformed an analysis tool's native                                  
	// reporting format into the SARIF format.                                                                                   
	Conversion                                                                                   *Conversion                     `json:"conversion,omitempty"`
